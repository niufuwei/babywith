...
//    int CheckOnline(const char *szDID); //add by wangmh
//    int SetPlayViewParamNotifyDelegate(const char *szDID, id<ParamNotifyProtocol> delegate); //add by wangmh
