...
public:
    ...
    int Start();
    void CheckOnline(); //added by wangmh
    int CheckOnlineReturn(); //added by wangmh
    int CheckUser(const char *user, const char *passwd); //added by wangmh
    int SetUserPwdForOther(const char *user,const char *passwd); //added by wangmh
    int RebootDevice(const char *user, const char *passwd); //added by wangmh
    void SetUserAndPwd(const char *user, const char *passwd); //added by wangmh
    void SetOnlineFlag(int flag); //added by wangmh
    void SetStop();
    ...
    void SetWifiParamsGettingDelegate(id delegate); //added by wangmh
...
protected:
    ...
    id <WifiParamsProtocol> m_WifiParamsGettingDelegate; //added by wangmh
